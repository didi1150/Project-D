 ...
 * the held item (HUD text displays above all) must run one tick later when the
 * swap has actually been applied.
 */
public final class BehaviorScheduler {
    ...
    /**
     * Run on the next server tick; falls back to immediate execution when the
